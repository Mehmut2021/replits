...
/*
The ``.set()`` ArrayList method will set the
value of a particular index to the given value.
...
The following code will set the element at the 2nd index to be 99 and
the element at the 0th index to be 100.
```
nums.set(2,99);
nums.set(0,100);
```
